...
@pytest.mark.asyncio
async def test_validation_error_returns_422(setup_test_api_keys):
...
@pytest.mark.asyncio
async def test_finboss_error_returns_500():
...
@pytest.mark.asyncio
async def test_main_app_validation_error_has_correct_structure(setup_test_api_keys):
